      ...
      <div class="newsletter-container">
        <div class="flex align-content-sm-center row">
          ...
          <div class="newsletter-content col-lg-6 col-md-7">
            <form action="https://acadarena.us2.list-manage.com/subscribe/post?u=5171ee53055ff235019e05d36&amp;id=bbdcedff9a&amp;f_id=00caabe0f0"
              method="post" 
  ...
  methods: {
    async subscribeToNewsletter() {
      ...
      if (this.email && this.email !== '' && emailPattern.test(this.email)) {
        ...
        //   }, {
        //     headers: {
        //       'Authorization': 'apikey 694859999a3a7a760200c608b60dca6c-us21',
